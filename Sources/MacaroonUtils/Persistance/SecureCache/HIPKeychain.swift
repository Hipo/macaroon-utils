...
open class HIPKeychain<Key: SecureCacheKey>: SecureCache {
    ...
    public init(
        ...
        _keychain =
            Valet.valet(with: Identifier(nonEmpty: identifier)!, accessibility: accessibility)
    }
    ...
    public subscript(
        ...
        set {
            ...
            try? _keychain.setString(
                string,
                forKey: key.secureCacheEncoded()
            )
        }
    }
